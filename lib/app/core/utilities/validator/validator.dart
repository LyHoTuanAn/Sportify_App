...
class NotEmpty extends Validator {
  ...
  @override
  String? validate(String? value) {
    return (value == null || value.trim().isEmpty) ? errorText : null;
  }
}

class LengthOtp extends Validator {
  LengthOtp(String errorText) : super(errorText, []);

  @override
  String? validate(String? value) {
    return (value!.length < 6) ? errorText : null;
  }
}
...
class ConfirmPasswordValidator extends Validator {
  ...
  @override
  String? validate(String? value) {
    return value == passwordController.text ? null : errorText;
  }
}

class NotDuplicateValue extends Validator {
  ...
  @override
  String? validate(String? value) {
    return value == oldValue ? errorText : null;
  }
}
...
class EmailValidator extends Validator {
  ...
  String? validate(String? value) {
    ...
    return EmailValidatorModel.validate(value) ? null : errorText;
  }
}
